...
GLOBAL_CONSTITUTION = (
    ...
    "4. HIERARCHY OF TRUTH: If a fact in 'tier_2_liquid' contradicts 'tier_1_immutable', 'tier_1_immutable' is the absolute truth. Ignore the conflicting tier 2 fact."
)
...
class EpistemicGovernorV22:
    def __init__(self):
        print("--- [SYSTEM]: Loading Dual-Brain Holographic Engine (Index 22 Patched)... ---")
        ...
        self.log_filename = f"telemetry_v22_{timestamp}.csv"
    ...
    def execute_mechanic(self, user_prompt, target_file):
        ...
        mechanic_prompt = (
            ...
            "   CRITICAL LIMIT: 'tier_2_liquid' can hold a MAXIMUM of 10 keys. If you hit this limit, do NOT just delete older facts. You MUST consolidate and merge related keys into a single summarized key to free up space.\n"
        ...
        try:
            ...
            # --- SCHEMA ARMOR V3: The Vault, Size Caps & The Shrapnel Limit ---
            ...
            if len(tier_2) > 10:
                return False, "Mechanic Error: Semantic Shrapnel. 'tier_2_liquid' exceeds the 10-key limit. Consolidate older facts to free up space."
        ...
        except BaseException as e:  # <--- PATCHED: Catches SystemExit from quit() or exit()
            return False, f"Mechanic Error: Blocked System Exception / Force Quit Attempted. {str(e)}"
...
def run_v22():
    ...
    print("\n--- INDEX 22: THE APEX GOVERNOR ONLINE ---")
    step = 0
